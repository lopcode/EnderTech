...
public class NBTDataWrapper implements MCDataInput, lib.data.MCDataOutput
{
    ...
    @Override
    public NBTDataWrapper writeCoord(lib.vec.BlockCoord coord)
    {
    ...
    {
        return new lib.vec.BlockCoord(readInt(), readInt(), readInt());
    }
