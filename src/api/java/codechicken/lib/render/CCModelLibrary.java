...
import lib.vec.Matrix4;
import lib.vec.Quat;
import lib.vec.Scale;
import lib.vec.Vector3;

import static lib.math.MathHelper.phi;
...
public class CCModelLibrary
{
    ...
    public static Matrix4 getRenderMatrix(Vector3 position, lib.vec.Rotation rotation, double scale)
    {
