...
{    
    ...
    public static lib.colour.Colour[] loadTextureColours(ResourceLocation resource)
    {
        int[] idata = loadTextureData(resource);
        lib.colour.Colour[] data = new lib.colour.Colour[idata.length];
