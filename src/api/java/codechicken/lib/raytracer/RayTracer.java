...
public class RayTracer
{
    ...
    private void traceSide(int side, Vector3 start, Vector3 end, lib.vec.Cuboid6 cuboid)
    {
        vec.set(start);
        Vector3 hit = null;
        switch(side)
    ...
    public MovingObjectPosition rayTraceCuboid(Vector3 start, Vector3 end, lib.vec.Cuboid6 cuboid)
    {
    ...
    public MovingObjectPosition rayTraceCuboid(Vector3 start, Vector3 end, lib.vec.Cuboid6 cuboid, lib.vec.BlockCoord pos)
    {
    ...
    public MovingObjectPosition rayTraceCuboid(Vector3 start, Vector3 end, lib.vec.Cuboid6 cuboid, Entity e)
    {
        MovingObjectPosition mop = rayTraceCuboid(start, end, cuboid);
        if(mop != null)
        {
    ...
    public MovingObjectPosition rayTraceCuboids(Vector3 start, Vector3 end, List<IndexedCuboid6> cuboids)
    {
        ...
        for(IndexedCuboid6 cuboid : cuboids)
        {
            ...
            {
                mop = new lib.raytracer.ExtendedMOP(mop, cuboid.data, s_dist);
                c_dist = s_dist;
                c_hit = mop;
                c_cuboid = cuboid;
            }
    ...
    public MovingObjectPosition rayTraceCuboids(Vector3 start, Vector3 end, List<IndexedCuboid6> cuboids, lib.vec.BlockCoord pos, Block block)
    {
    ...
    public void rayTraceCuboids(Vector3 start, Vector3 end, List<IndexedCuboid6> cuboids, lib.vec.BlockCoord pos, Block block, List<lib.raytracer.ExtendedMOP> hitList)
    {
        for(IndexedCuboid6 cuboid : cuboids)
        {
            MovingObjectPosition mop = rayTraceCuboid(start, end, cuboid);
            if(mop != null)
            {
                lib.raytracer.ExtendedMOP emop = new lib.raytracer.ExtendedMOP(mop, cuboid.data, s_dist);
