...
public class Canvas9Seg
{
    ...
    private int[] readMarkers(lib.render.TextureDataHolder data, int stride, int size) {
    ...
    private void parseMarkers(lib.render.TextureDataHolder data, int stride, int size, int[] sizes, float[] texcoords) {
    ...
    private void load() {
        lib.render.TextureDataHolder data = lib.render.TextureUtils.loadTexture(tex);
    ...
    public void draw(int x, int y, int w, int h) {
        lib.render.CCRenderState.changeTexture(tex);
        lib.render.CCRenderState.reset();
