...
public class Vector3
{
    ...
    public Vector3 YZintercept(Vector3 end, double px)
    {
        ...
        double d = (px - x) / dx;
        if(lib.math.MathHelper.between(-1E-5, d, 1E-5))
            return this;
        
        if(!lib.math.MathHelper.between(0, d, 1))
            return null;
    ...
    {
        return lib.math.MathHelper.between(x - 1E-5, v.x, x + 1E-5) &&
                lib.math.MathHelper.between(y - 1E-5, v.y, y + 1E-5) &&
                lib.math.MathHelper.between(z - 1E-5, v.z, z + 1E-5);
    }
