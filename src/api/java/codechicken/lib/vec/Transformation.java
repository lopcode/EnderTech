...
{   
     ...
     */
    public abstract void apply(lib.vec.Vector3 vec);
    
    /**
     * Applies this transformation to a normal (doesn't translate)
     * @param normal The normal to transform
     */
    public abstract void applyN(lib.vec.Vector3 normal);
    ...
    {
        return new lib.vec.TransformationList(new lib.vec.Translation(-point.x, -point.y, -point.z), this, point.translation());
    }
     ...
     */
    public lib.vec.TransformationList with(Transformation t)
    {
        return new lib.vec.TransformationList(this, t);
    }
    ...
    public lib.vec.TransformationList $plus$plus(Transformation t)
    {
        return with(t);
    }
}
