...
public class TransformationList extends Transformation
{
    ...
    public lib.vec.Matrix4 compile()
    {
        if(mat == null)
        {
            mat = new lib.vec.Matrix4();
     ...
     * @return
     */
    public lib.vec.Matrix4 reverseCompile()
    {
        lib.vec.Matrix4 mat = new lib.vec.Matrix4();
