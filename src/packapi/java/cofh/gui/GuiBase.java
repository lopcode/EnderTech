...
/**
 * Base class for a modular GUIs. Works with Elements {@link cofh.gui.element.ElementBase} and Tabs {@link cofh.gui.element.TabBase} which are both modular elements.
 * 
 * @author King Lemming
 */
