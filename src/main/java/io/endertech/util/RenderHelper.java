...
public class RenderHelper
{
    ...
    public static void renderBlockOutline(RenderGlobal context, EntityPlayer entityPlayer, BlockCoord blockCoord, RGBA colour, float lineWidth, float partialTicks)
    {
        ...
        context.drawOutlinedBoundingBox(block.getSelectedBoundingBoxFromPool(entityPlayer.worldObj, blockCoord.x, blockCoord.y, blockCoord.z).expand((double) f1, (double) f1, (double) f1).getOffsetBoundingBox(-d0, -d1, -d2), -1);
